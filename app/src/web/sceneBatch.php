		...
		if (file_exists($mpo)) {
			...
			*/
			if(file_exists($place."_CD.jpg") && !file_exists($place."_Colour_CD.jpg")){
				$tempString = "//webshare.fos.auckland.ac.nz/web/www.ivs.auckland.ac.nz/stereogalley_run/disparityColourCoded.exe //webshare.fos.auckland.ac.nz/web/www.ivs.auckland.ac.nz/stereogalley_run/".$place."_CD.jpg //webshare.fos.auckland.ac.nz/web/www.ivs.auckland.ac.nz/stereogalley_run/".$place."_Colour_CD.jpg";
				print $tempString."<br/>";
	...
	foreach ($arrayMPO as $mpo){
		...
		if (file_exists($mpo)) {		
			...
			if(file_exists($place."_".$algorithm.".jpg") && !file_exists($place."_stereogram.jpg")){
				...
				$newPlace = str_replace("../stereogallery/","//webshare.fos.auckland.ac.nz/web/www.ivs.auckland.ac.nz/stereogallery/",$place);
				print("autostereogramLocal.exe $newPlace"."_".$algorithm.".jpg $newPlace"."_l_resized.jpg //webshare.fos.auckland.ac.nz/web/www.ivs.auckland.ac.nz/web/images/mask/rainDrop.jpg 1 1  $newPlace"."_stereogram.jpg");
				echo "<br/>";
				print("autostereogramLocal.exe $newPlace"."_".$algorithm.".jpg $newPlace"."_l_resized.jpg //webshare.fos.auckland.ac.nz/web/www.ivs.auckland.ac.nz/web/images/mask/rainDrop.jpg 0 1  $newPlace"."_p_stereogram.jpg");
				echo "<br/>";
