<?
$file = "../../quick_stereo/upload_stereo/".$_GET["location"]."/coordinates.obj";

include('simpleimage.php');
$image = new SimpleImage();
$image->load("../../quick_stereo/upload_stereo/".$_GET["location"]."/texture.jpg");
$image->resize(256,256);
$image->save("../../quick_stereo/upload_stereo/".$_GET["location"]."/gl_texture.jpg");
...
<script type="text/javascript">
    ...
    function initTexture() {
        ...
        objectItTexture.image.src = "../../quick_stereo/upload_stereo/<? echo $_GET['location']; ?>/gl_texture.jpg?"+randomString();
    }
