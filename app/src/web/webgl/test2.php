<?
$file = "../../quick_stereo/upload_stereo/coordinates.obj";
$f = fopen($file, "r");
$outString = "";
$outStringF = "";
...
<script type="text/javascript">
    ...
    function initGL(canvas) {
        ...
        if (!gl) 
		{
			...
			document.getElementById('alertPanel').innerHTML='<div align="center"><h1>Could not initialise WebGL in your Browser. <br>Please use Google Chrome instead<br>or view this by Java3D. <br>Thanks!</h1></div>';
    ...
    function initTexture() {
        ...
        objectItTexture.image.src = "../../quick_stereo/upload_stereo/gl_texture.jpg?"+randomString();
    }
 ...
 */
    ...
    function initBuffers() {
        ...
        for (var i=0; i < facess.length; i++) {    		
			//print face;	
			var face = parseInt(facess[i]) - 1;
			var x = -coordinatess[3*face];//cosPhi * sinTheta;
			var y = coordinatess[3*face+1];//cosTheta;
			var z = -coordinatess[3*face+2];//(sinPhi * sinTheta); if(z < 0) z*= -1;
			var u = (x+(<? echo $maxX ?>))/(<? echo ($maxX - $minX) ?>);
			var v = (y-(<? echo $minY ?>))/(<? echo ($maxY - $minY) ?>);
    ...
    function drawScene() {
		...
		//}
		//else{
		//	gl.drawElements(gl.GL_LINES, objectItVertexIndexBuffer.numItems, gl.UNSIGNED_SHORT, 0);
...
<div id="alertPanel" style="vertical-align:middle"></div>
<canvas id="webgl_canvas" style="border: none;" width="800" height="500">  
</canvas>
</body>
