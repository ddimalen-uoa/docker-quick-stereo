...
<link rel="stylesheet" href="https://code.jquery.com/ui/1.10.3/themes/smoothness/jquery-ui.css" />
      ...
      <style>
          ...
          #sliderwrapper{
              ...
              position:relative;
              width:38px; height:600px;
              border:1px solid white;
			  background:url(depthPix.png);
...
if(intval($_GET['delay'])>0){
	$wait = 1000+intval($_GET['delay'])*1000;
}
else{
	$wait = 1000;
}
...
<canvas id="webgl_canvas" style="border: none; display:none;" width="680" height="600"></canvas>
...
<script type="text/javascript">
	...
	function counterSliderNew(sID, maxValue,theSliderValue) {
		depthRatio = theSliderValue/100.0;
		initBuffers();
	}
</script>
