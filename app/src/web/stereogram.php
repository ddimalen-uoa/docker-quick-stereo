...
if($_SERVER['REQUEST_METHOD'] == "POST"){
	...
	fwrite($fp, "//webshare.fos.auckland.ac.nz/web/www.ivs.auckland.ac.nz/web/shadow/".$_POST["depthMap"]);
	fwrite($fp, "\n");
	fwrite($fp, "//webshare.fos.auckland.ac.nz/web/www.ivs.auckland.ac.nz/web/shadow/".$_POST["patternMap"]);
	fwrite($fp, "\n");
	fclose($fp);
}
	...
	$fp = fopen('shadow/stereogram.txt', 'w');
	fwrite($fp, "//webshare.fos.auckland.ac.nz/web/www.ivs.auckland.ac.nz/quick_stereo/upload_stereo/".$_GET["location"]."/result.jpg");
	fwrite($fp, "\n");
