...
<body bgcolor="#F4FFE4" onload="window.location = window.location + '#<? echo $_GET["cite"]; ?>';">
<table width="100%" border="0" cellspacing="0" cellpadding="0">
 ...
 <tr>
	...
	<table border="0" cellspacing="0" cellpadding="0" width="100%">
        <tr>
          <td class="pageName">Bibliography</td>
		</tr>
		...
		<tr>
          <td class="bodyText"><p>
			...
			while ( $line = fgets($f, 1000) ) {
				...
				if(substr($line, 0, 1) == '@'){
					$note = explode("{", $line); $note = explode(",", $note[1]); $note = trim($note[0]);
					if($cite == $note){
						print "<a name='".$note."'><hr><strong class = 'highlight'>".$line."</strong><br>";
					}
					else{
						print "<a name='".$note."'><hr><strong>".$line."</strong><br>";
					}
