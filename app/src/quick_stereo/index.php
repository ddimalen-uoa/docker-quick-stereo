...
ini_set('display_errors', '0');  // don't show in HTML
ini_set('log_errors', '1');      // do log to error_log
...
loggit("The time it took to reach this line 73: ", $duration);
// TIMER BLOCK
...
if ($f) {
    if (flock($f, LOCK_SH | LOCK_NB)) { // shared lock, non-blocking
        $line = fgets($f, 1000);
        flock($f, LOCK_UN);
    } else {
        loggit("File is currently being written. Try again later.");
    }
    fclose($f);
} else {
    loggit("Failed to open file.");
}
...
loggit("The time it took to reach this line 100: ", $duration);
// TIMER BLOCK
...
loggit("The time it took to reach this line 113: ", $duration);
// TIMER BLOCK
...
if ($different != "" && intval($different) < 1000) {
    $serverOn = true;
} else {
    $serverOn = false;
}
...
if ($_SERVER['REQUEST_METHOD'] == "POST" && $_REQUEST["smooth"] != '') {
    ...
    unlink($pathSegment);
    unlink($thisdir . "/left_raw_resized.jpg");
    unlink($thisdir . "/depthReserved.jpg");
    ...
    if (($ufile != none && $ufile2 != none) || $ufileMPO != none || $ufileLeftRight != none || $ufileSteregram != none) {
        ...
        if (($extension != "jpg") && ($extension != "jpeg") && ($extension != "bmp") && ($extension != "png") && ($extension != "ppm") && ($extension != "")) {
            ...
            if ((strtolower($extension3) == "mpo")) {
                copy($_FILES['ufileMPO']['tmp_name'], $pathMPO);
            } else if ((strtolower($extension3) == "jps") || (strtolower($extension3) == "pns")) {
                copy($_FILES['ufileMPO']['tmp_name'], $pathLeftRight);
                $crossEye = 1;
            }
            copy($_FILES['ufileLeftRight']['tmp_name'], $pathLeftRight);
            if (copy($_FILES['ufileStereogram']['tmp_name'], $pathStereogram)) {
                copy($_FILES['ufileStereogram']['tmp_name'], $path);
                copy($_FILES['ufileStereogram']['tmp_name'], $path2);
            ...
            copy($_FILES['ufileAnaglyph']['tmp_name'], $pathAnaglyph);
...
<head>
    ...
    <?php
    if ($_SESSION["smartPhoneDevice"] == "iPod") //if(true)
    {
        ?>
...
<body
    onLoad="hideAll();display('leftUpload');display('rightUpload');updateProcessingTime(document.getElementById('algorithm').value);">
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr class="extra">
        <td colspan="7" bgcolor="#fff">
            [Server is <?php if ($serverOn) echo "ACTIVE"; else echo "INACTIVE"; ?>, reported at <?php echo $line; ?>]
            [Session:
            <?php
            if (isset($_SESSION["postSession"]))
    ...
    <tr>
        ...
        <td colspan="4" valign="top" class="mainForIphone">
            ...
            <table border="0" cellspacing="0" cellpadding="0" width="100%">
                <tr>
                    <td class="pageName">
                        Online Computational Stereo Vision - last updated 15/07/2025<br/>
                        <?php
                        ...
                        <table width="100%" border="0" style="vertical-align:top; text-align:center">
                            <tr>
                                <td width="100%" id="bodyText">
                                    <h2 align="center"><span class="extra">Choose types and </span>upload stereo
                                        images<span class="extra">, <a
                                                href="javascript:alert('Please select the follow image types.');">select</a> from the following input types:</span>
                                    </h2>
                                    <!-- FORM -->
                                                ...
                                                <td colspan="2">
                                                    <table width="95%" border="0" cellspacing="1" cellpadding="1">
                                                        <tr class="extra">
                                                            <td colspan="2">
                                                                <div align="left">
                                                                    <table width="100%" border="1" bgcolor="#fff"
                                                                           onClick="document.getElementById('rectification').selectedIndex=0;"
                                                                           class="tableControl">
                                                                        <tr>
                                                                            <td width="16.66%" class="inputType"
                                                                                id="inputTable1" onClick="
																							hideAll();
																							display('leftUpload');
																							display('rightUpload'); ">
                                                                                <div align="center">
                                                                                    <img src="leftPlusRight.jpg"
                                                                                         width="100%"
                                                                                         alt="Need help ? Go to 'Instructions' tab"
                                                                                         title="Need help ? Go to 'Instructions' tab"/><br/>
                                                                            ...
                                                                            <td width="16.66%" class="inputType"
                                                                                ...
                                                                                <div align="center">
                                                                                    <img src="leftRight.jpg" width="90%"
                                                                                         alt="Need help ? Go to 'Instructions' tab"
                                                                                         title="Need help ? Go to 'Instructions' tab"/><br/>
                                                                            ...
                                                                            <td width="16.66%" class="inputType"
                                                                                ...
                                                                                <div align="center">
                                                                                    <img src="anaglyphs.jpg" width="75%"
                                                                                         alt="Need help ? Go to 'Instructions' tab"
                                                                                         title="Need help ? Go to 'Instructions' tab"/><br/>
                                                        ...
                                                        <tr id="rightUpload" <?php if ($_SESSION["smartPhoneDevice"] != "iPod") echo 'style="display:none"'; ?>>
                                                            ...
                                                            <td>
                                                                <div align="left">
                                                                    <input name="ufile2" type="file" id="ufile2"
                                                                           size="50"/>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr id="mpoUpload" style="display:none">
                                                            <td width="25%">
                                                                <div align="left">Select <strong>.MPO .JPS .PNS
                                                                        image</strong>:
                                                                </div>
                                                            </td>
                                                            <td width="75%">
                                                                <div align="left">
                                                                    <input name="ufileMPO" type="file" id="ufileMPO"
                                                                           size="50"/>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr id="leftRightUpload" style="display:none">
                                                            <td width="25%">
                                                                <div align="left">Select a <strong>combined
                                                                        <select name="leftRightImage"
                                                                                id="leftRightImage" onChange="
                                                                            ...
                                                                            <option value="left/right image">left/right
                                                                                image
                                                                            </option>
                                                                            <option value="left/right URL">left/right
                                                                                URL
                                                                            </option>
                                                                        </select>
                                                                    </strong>:
                                                            ...
                                                            <td width="75%">
                                                                <div align="left">
                                                                    <input name="ufileLeftRight" type="file"
                                                                           id="ufileLeftRight" size="50%"/>
                                                                    <input name="crossEye" id="crossEye0" type="radio"
                                                                           value="0" checked="checked"/>
                                                                    Crossed eye
                                                                    <input type="radio" name="crossEye" id="crossEye1"
                                                                           value="1"/>
                                                                    Paralleled eye
                                                                </div>
                                                            </td>
                                                        ...
                                                        <tr id="stereogramUpload" style="display:none">
                                                            <td width="25%">
                                                                <div align="left">Select a<strong>
                                                                        <select name="stereogramImage"
                                                                                id="stereogramImage" onChange="
                                                                            ...
                                                                            <option value="stereogram image">stereogram
                                                                                image
                                                                            </option>
                                                                            <option value="stereogram URL">stereogram
                                                                                URL
                                                                            </option>
                                                                        </select></strong>:
                                                                </div>
                                                            ...
                                                            <td width="75%">
                                                                <div align="left">
                                                                    <input name="ufileStereogram" type="file"
                                                                           id="ufileStereogram" size="50"/>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr id="anaglyphUpload" style="display:none">
                                                            <td width="25%">
                                                                <div align="left">Select an</strong>
                                                                    <select name="anaglyphImage" id="anaglyphImage"
                                                                            onChange="
                                                                        ...
                                                                        <option value="anaglyph image">anaglyph image
                                                                        </option>
                                                                        <option value="anaglyph URL">anaglyph URL
                                                                        </option>
                                                                    </select>:
                                                                </div>
                                                            </td>
                                                            <td width="75%">
                                                                <div align="left">
                                                                    <input name="ufileAnaglyph" type="file"
                                                                           id="ufileAnaglyph" size="50"/>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr class="extra">
                                                        ...
                                                        <tr class="extra">
                                                            ...
                                                            <td>
                                                                <div align="left">
                                                                    <select name="rectification" id="rectification"
                                                                            onChange="
																					if(this.value == '2') 
																					{
                                                                        ...
                                                                        <option
                                                                            value="0" <?php if (isset($_REQUEST["rectification"]) && $_REQUEST["rectification"] == '0') echo "selected"; ?>>
                                                                            Automatic
                                                                        </option>
                                                                        <option
                                                                            value="1" <?php if (isset($_REQUEST["rectification"]) && $_REQUEST["rectification"] == '1') echo "selected"; ?>>
                                                                            No, they already aligned
                                                                        </option>
                                                        ...
                                                        <tr class="extra">
                                                            ...
                                                            <td>
                                                                <div align="left">
                                                                    <select name="full_disparity" id="full_disparity"
                                                                            onChange="//alert('This change might lead to longer processing time, please be patient');">
                                                                        <option
                                                                            value="1" <?php if (isset($_REQUEST["full_disparity"]) && $_REQUEST["full_disparity"] == '1') echo "selected"; ?>>
                                                                            No
                                                                        </option>
                                                                        <option
                                                                            value="16" <?php if (isset($_REQUEST["full_disparity"]) && $_REQUEST["full_disparity"] == '16') echo "selected"; ?>>
                                                                            16 levels
                                                                        </option>
                                                                        <option
                                                                            value="32" <?php if (isset($_REQUEST["full_disparity"]) && $_REQUEST["full_disparity"] == '32') echo "selected"; ?>>
                                                                            32 levels
                                                                        </option>
                                                                        <option
                                                                            value="48" <?php if (isset($_REQUEST["full_disparity"]) && $_REQUEST["full_disparity"] == '48') echo "selected"; ?>>
                                                                            48 levels
                                                                        </option>
                                                                        <option
                                                                            value="64" <?php if (isset($_REQUEST["full_disparity"]) && $_REQUEST["full_disparity"] == '64') echo "selected"; ?>>
                                                                            64 levels
                                                                        </option>
                                                                        <option
                                                                            value="72" <?php if (isset($_REQUEST["full_disparity"]) && $_REQUEST["full_disparity"] == '72') echo "selected"; ?>>
                                                                            72 levels
                                                                        </option>
                                                                        <option
                                                                            value="96" <?php if (isset($_REQUEST["full_disparity"]) && $_REQUEST["full_disparity"] == '96') echo "selected"; ?>>
                                                                            96 levels
                                                                        </option>
                                                                        <option
                                                                            value="128" <?php if (isset($_REQUEST["full_disparity"]) && $_REQUEST["full_disparity"] == '128') echo "selected"; ?>>
                                                                            128 levels
                                                                        </option>
                                                                        <option
                                                                            value="256" <?php if (isset($_REQUEST["full_disparity"]) && $_REQUEST["full_disparity"] == '256') echo "selected"; ?>>
                                                                            256 levels
                                                                        </option>
                                                                    </select>
                                                        ...
                                                        <tr class="extra">
                                                            <td>
                                                                <div align="left">
                                                                    <label>
                                                                        <select name="autoMinDisp" id="autoMinDisp"
                                                                                onChange="
                                                                            ...
                                                                            <option
                                                                                value="1" <?php if ($_REQUEST["autoMinDisp"] == '1') echo "selected"; ?>>
                                                                                Auto detected
                                                                            </option>
                                                                            <option
                                                                                value="0" <?php if ($_REQUEST["autoMinDisp"] == '0') echo "selected"; ?>>
                                                                                Manual entered
                                                                            </option>
                                                                        </select>
                                                                    </label>
                                                            ...
                                                            <td>
                                                                <div align="left">
                                                                    <input name="minDisp" type="text" id="minDisp"
                                                                           value="<?php if (isset($_REQUEST["minDisp"])) echo $_REQUEST["minDisp"]; else echo $interestParameters[0]; ?>"
                                                                           size="40" <?php if ($_SERVER['REQUEST_METHOD'] != 'POST' || $_REQUEST["autoMinDisp"] == '1') echo "disabled=\"disabled\""; ?> />
                                                        ...
                                                        <tr class="extra">
                                                            <td>
                                                                <div align="left">
                                                                    <select name="autoMaxDisp" id="autoMaxDisp"
                                                                            onChange="
                                                                        ...
                                                                        <option
                                                                            value="1" <?php if ($_REQUEST["autoMaxDisp"] == '1') echo "selected"; ?>>
                                                                            Auto detected
                                                                        </option>
                                                                        <option
                                                                            value="0" <?php if ($_REQUEST["autoMaxDisp"] == '0') echo "selected"; ?>>
                                                                            Manual entered
                                                                        </option>
                                                                    </select>
                                                                    maximum disparity:
                                                            ...
                                                            <td>
                                                                <div align="left">
                                                                    <input name="maxDisp" type="text" id="maxDisp"
                                                                           value="<?php if (isset($_REQUEST["maxDisp"])) echo $_REQUEST["maxDisp"]; else echo $interestParameters[1]; ?>"
                                                                           size="40" <?php if ($_SERVER['REQUEST_METHOD'] != 'POST' || $_REQUEST["autoMaxDisp"] == '1') echo "disabled=\"disabled\""; ?> />
                                                                    (*) Positive value only
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr class="extra">
                                                            ...
                                                            <td>
                                                                <div align="left">
                                                                    <input name="disparityScale" type="text"
                                                                           id="disparityScale"
                                                                           value="<?php if (isset($_REQUEST["disparityScale"])) echo $_REQUEST["disparityScale"]; else echo '1'; ?>"
                                                                           size="40"/>
                                                        ...
                                                        <tr class="extra">
                                                            ...
                                                            <td>
                                                                <div align="left">
                                                                    <input name="smooth" type="text" id="smooth"
                                                                           value="<?php if (isset($_REQUEST["smooth"])) echo $_REQUEST["smooth"]; else echo '0'; ?>"
                                                                           size="40"/>
                                                                    (*) Positive value only and less than 50, ie: 1 2
                                                                    3...
                                                                </div>
                                                            </td>
                                                        </tr>
                                                            ...
                                                            <td>
                                                                <div align="left">
                                                                    <input name="coordinates" type="text"
                                                                           id="coordinates"
                                                                           value="<?php if (isset($_REQUEST["coordinates"])) echo $_REQUEST["coordinates"]; else echo '35'; ?>"
                                                                           size="40" readonly/>
                                                                ...
                                                                <div align="center">
                                                                    <table width="100%" border="0" cellspacing="0"
                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                                <div align="center">
                                                                                    <strong id="expectedTime">Average
                                                                                        waiting time: ?? &#177; ??
                                                                                        seconds excluding upload and
                                                                                        download time!</strong><br/>
                                                                                    <input type="hidden"
                                                                                           name="MAX_FILE_SIZE"
                                                                                           value="10000"/>
                                                                                    ...
                                                                                    <input
                                                                                        onClick="f_agree_process(this.id)"
                                                                                        name="submitButton"
                                                                                        type="button"
                                                                                        class="submitButton"
                                                                                        id="submitButton"
                                                                                        value="Process/Submit"/>
                                                                                    or <a
                                                                                        href="index.php">Reset</a><br/>
                                                                                </div>
                                                                                <!--
                                                        ...
                                                        <tr class="extra">
                                                            <td colspan="2">
                                                                <div align="left">
                                                                    <ul>
                                                                        <li>File allowed:<strong> JPG, JPEG, PNG, PPM,
                                                                                MPO</strong>, large images will be
                                                                            automatically <strong>resized</strong> to
                                                                            the <strong>above width</strong>.
                                                                        </li>
                                                                        <li>If you only change parameters, <strong>click
                                                                                Submit </strong>again to re-calculate
                                                                            the result.
                                                                        </li>
                                                                        <li><a href="../web/scene_gallery.php"><strong>Click
                                                                                    here</strong></a> to access the
                                                                            gallery page, or check <a
                                                                                href="../web/demo.php"><strong>our
                                                                                    demo</strong></a> page.
                                                                        </li>
                                                                    </ul>
                                                                    <p id="tempoWaiting"
                                                                       style=" text-align:center;display:none;background:url(upload_stereo/processGoal.jpg); background-repeat:no-repeat; background-position:center; text-align:center;">
                                                                        <img src="../images/waiting.gif" width="640"
                                                                             height="480"></p>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <?php if ($_SERVER['REQUEST_METHOD'] != "POST") {
                                                            ...
                                                            <tr>
                                                                <td colspan="4"><br/>
                                                                    Below is the previously processed dataset, <strong>hover
                                                                        over to see its 3D scene</strong>.<br/>

                                                                    <?php echo $parameterReturned; ?><br/>
                                                                    <a href="3dNav/" target="_blank">Click to view it in
                                                                        an external page?</a>
                                                                </td>
                                                            </tr>
                                                                    ...
                                                                    <table width="100%" border="1" cellspacing="1"
                                                                        ...
                                                                        <tr>
                                                                            <td colspan="4" height="810">
                                                                                ...
                                                                                <iframe id="reversedLeftImage"
                                                                                        src="3dNav"
                                                                                        height="800" width="550"
                                                                                        class="displayResult"></iframe>


                                                                                <iframe id="WebGL"
                                                                                        src="../web/webgl/sceneGLTrans.php"
                                                                                        height="650" width="600"
                                                                                        class="displayResult"
                                                                                        style="border:hidden;"></iframe>

                                                                            </td>
                                                                            <?php } else { ?>
                                                                                <h2 class="style1">No cached images
                                                                                    found, <br/>
                                                                                    server is maybe busy processing some
                                                                                    images.<br/>
                                                                        ...
                                                                        <tr>
                                                                            <td colspan="4">
                                                                                <a href="https://www.ivs.auckland.ac.nz/quick_stereo/viewModelVR.php"
                                                                                   target="_blank"> <img
                                                                                        src="img/vrButton.png"
                                                                                        alt="vrButton"
                                ...
                                <tr style="height:100%;">
                                    <td bgcolor="<?php echo $background; ?>">
                                        ...
                                        <div align="center" id="result_pad" style="height:100%">
                                            <p>&nbsp;</p>
                                            <h1 align="center"
                                                style="color:#000; background:#CCCCCC; border:medium; border-color:#000">
                                                Images received, stereo reconstruction is processing, <br/>
                                                estimating total waiting time...&nbsp;</h1>
                                            </p>
                                            <p id="tempoWaiting"
                                               style=" text-align:center;background:url(upload_stereo/processGoal.jpg); background-repeat:no-repeat; background-position:center; text-align:center;">
                                                <img class="intermediatedResult" src="../images/waiting.gif"></p>
                                        </div>
                                        <script language="JavaScript" type="text/javascript">
                                    ...
                                    <td>
                                        <table width="100%" border="0" cellspacing="2" cellpadding="0">
                                            <tr>
                                                <td valign="top">
                                                    <!--
														<iframe src="https://<?php echo $_SERVER['HTTP_HOST']; ?>/imageProcessing" height="800" width="600"></iframe>
														-->
                                                </td>
                                            </tr>
                                        </table>
