...
if (copy($olddir."/texture.jpg", $newdir."/texture.jpg")) {
...
<p align="center"><strong> and Java3D must be installed as well, please <a href="http://java3d.dev.java.net/binary-builds.html">click here to install Java3D</a></strong></p>
