...
class PHPMailer {
  ...
  function SetLanguage($lang_type, $lang_path = 'language/') {
  	// Modified for Conftool: Only english is required for system error messages...
  ...
  function CreateHeader() {
    ...
    // Modified for ConfTool
    //$result .= $this->HeaderLine('X-Mailer', 'PHPMailer (phpmailer.sourceforge.net) [version ' . $this->Version . ']');
    $result .= $this->HeaderLine("X-Mailer", "ConfTool ".ctconf_get('version')." / via PHPMailer [version " . $this->Version . "]");     
