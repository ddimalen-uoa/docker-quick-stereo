                          ...
                          <div style="text-align:center;">
						    ...
						    <table border="1" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
                              ...
                              <tr height="20">
                                ...
                                <td rowspan="2" bgcolor="#BBBBFF"><strong>Keynote: Timo Ropinski</strong></td>
                              </tr>
                              <tr height="20">
                              ...
                              <tr height="20">
								...
								extract($row);
								echo '<li><a href="http://www.ivs.auckland.ac.nz/ivcnz2011_temp/htdocs/index.php?page=adminPapersDetails&form_id='.$id.'" target="_blank">"'.$title.'"</a></li>';							
								//echo $author;
								//echo "<br>";
								}
								?> 
                              ...
                              <tr height="20">
								...
								?></td>
                                <td rowspan="6" bgcolor="#CCFFFF">Lunch Break</td>
                              </tr>
                              <tr height="20">
                              ...
                              <tr height="20">
                                ...
                                <td rowspan="3" bgcolor="#FFCCCC">Conference Closing and Awards</td>
                              </tr>
