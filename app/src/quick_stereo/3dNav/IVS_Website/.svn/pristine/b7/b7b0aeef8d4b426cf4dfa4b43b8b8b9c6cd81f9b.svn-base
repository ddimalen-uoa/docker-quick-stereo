	  ...
	  <table width="100%" border="0" cellpadding="0" cellspacing="5">
	    ...
	    <tr>
	      <td class="bodyText"><p align="center">We introduce a new and versatile web-based system which allows users to <strong>dynamically generate surfaces of three-dimensional (3D) scenes</strong> from <strong>stereo image pairs</strong> taken with monocular and stereo cameras or web-cams.  <br />
	        ...
	        The system is portable, simple to set up and operate, and is currently available online at <a href="http://www.ivs.auckland.ac.nz/quick_stereo"><strong>http://www.ivs.auckland.ac.nz/quick_stereo</strong></a>. <br />
	        ...
	        <p align="center">
	          <!--<iframe width="425" height="349" src="http://www.youtube.com/embed/KRL3KUBKoxE?hl=en&amp;fs=1" frameborder="0" allowfullscreen="allowfullscreen"></iframe>-->
              <iframe src="http://www.ivs.auckland.ac.nz/web/displayGallery.php" height="680" width="860"></iframe>
            </p>
...
Set default value from<strong> 0</strong> to <strong>1</strong>.</p>
    ...
    <table width="190" border="0" align="right" cellpadding="0" cellspacing="0" id="leftcol2">
      <?
