					...
					<div id='div_ivcnz_main'>
						...
						<div id='right_pad'>
                          <div style="text-align:center;">
						    ...
						    <h1 style="margin-top:0px;"><span class="style2">Contacts</span></h1>
                          </div>                         
                          <p align="center">Any queries please contact the Convenors:</p>
                          <p align="center"><a href="mailto:IVCNZ2011@cs.auckland.ac.nz">IVCNZ2011@cs.auckland.ac.nz</a></p>
                          <? echo importantDate();?>
						  <hr>
