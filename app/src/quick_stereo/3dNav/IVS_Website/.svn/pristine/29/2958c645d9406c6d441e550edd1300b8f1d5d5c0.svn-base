...
<script type="text/javascript">
    ...
    function initTexture() {
        ...
        moonTexture.image.src = "texture_.jpg";
    }
    ...
    function initBuffers() {
        ...
        for (var latNumber=0; latNumber <= latitudeBands; latNumber++) {   
            for (var longNumber=0; longNumber <= longitudeBands; longNumber++) {
                ...
                var x = -coordinatess[counter++];//cosPhi * sinTheta;
                var y = coordinatess[counter++];//cosTheta;
                var z = 0;//-coordinatess[counter++];//(sinPhi * sinTheta); if(z < 0) z*= -1;
                var u = x+0.5;
                var v = y+0.3;
    ...
    function drawScene() {
        ...
        mat4.translate(mvMatrix, [-0.5, +0.5, -6]);
...
<canvas id="lesson11-canvas" style="border: none;" width="1000" height="700"></canvas>
    <br/>
