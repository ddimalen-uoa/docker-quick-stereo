...
function rotateImages(){
	...
	document.getElementById('WebGL').src='http://www.ivs.auckland.ac.nz/web/webgl/sceneGLTrans.php?location='+setImage;
}
</script>
</head>
<body bgcolor="#000000" onload="setInterval('rotateImages();',20000);">
<iframe id="WebGL" src="http://www.ivs.auckland.ac.nz/web/webgl/sceneGLTrans.php?location=<? echo $firstImage; ?>" height="650" width="850" style="border:hidden"></iframe>
</body>
</html>