...
$counter = 1000;
$counting=0;
$step = array($counting++=>'resultP1', $counting++=>'resultO1', $counting++=>'resultO2', $counting++=>'resultP2', $counting++=>'resultO3', 
$counting++=>'resultP3', $counting++=>'resultO4', 
$counting++=>'resultO5', $counting++=>'resultO6', $counting++=>'resultO7');

for($i = 0; $i < sizeof($step); $i++){
	//echo $step[$i];	echo "<hr>";
	while($row = mysql_fetch_assoc(${$step[$i]})){	
		extract($row);
		//echo $counter;
		//echo ": ";	
		//echo $filename;
		...
		//echo $ext;		
		copy("../ivcnz2011_temp/uploads/".$filename, "../ivcnz2011_temp/uploads/print_papers/".$counter.".".$ext);
		$counter = $counter+1;
	}
                          ...
                          <div style="text-align:center;">
						    ...
						    <table border="1" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
                              ...
                              <tr height="20">
                                ...
                                <td rowspan="2" bgcolor="#BBBBFF"><strong>Keynote: Timo</strong></td>
                              </tr>
                              <tr height="20">
                              ...
                              <tr height="20">
								...
								extract($row);
								echo '<a href="http://www.ivs.auckland.ac.nz/ivcnz2011_temp/htdocs/index.php?page=adminPapersDetails&form_id='.$id.'" target="_blank">"'.$title.'"</a>';
								echo "<br>";
								echo $author;
								}
								?></td>
                              ...
                              <tr height="20">
                                ...
                                <td rowspan="3" bgcolor="#CCFFFF">Cofee break&nbsp;</td>
                              </tr>
                              ...
                              <tr height="20">
								...
								extract($row);
								echo '<li><a href="http://www.ivs.auckland.ac.nz/ivcnz2011_temp/htdocs/index.php?page=adminPapersDetails&form_id='.$id.'" target="_blank" onMouseover="ddrivetip(\''.$title.' - '.$author.'\',\'yellow\', 400)";
onMouseout="hideddrivetip()">"'.substr($title,0,20).'..."</a></li>';								
								//echo $author;
								//echo "<br>";
								}
								?> 
                              ...
                              <tr height="20">
                                <td rowspan="2" align="right" valign="top" bgcolor="#CCCCCC"><div align="right">10:30</div>                                  <div align="right"></div>                                  <div align="right"></div>                                  <div align="right"></div></td>
                                <td rowspan="2" bgcolor="#FFFFCC"><? 
								if($row = mysql_fetch_assoc($resultO3)){	
								extract($row);
								echo '<a href="http://www.ivs.auckland.ac.nz/ivcnz2011_temp/htdocs/index.php?page=adminPapersDetails&form_id='.$id.'" target="_blank">"'.$title.'"</a>';
								...
								?></td>
                                <td height="20" bgcolor="#FFFFCC"><strong>Oral session 6<br>
                                Image enhancement and    processing<br>
                                Chair: Donal Bailey</strong></td>
                              </tr>
...
onMouseout="hideddrivetip()">"'.substr($title,0,20).'..."</a></li>';								
                              ...
                              <tr height="20">
                                ...
                                <td rowspan="4" bgcolor="#CCFFFF">Lunch Break</td>
                              </tr>
                              ...
                              <tr height="20">
                                ...
                                Chair: Brendan Mc    Cane</strong></td>
                              </tr>
...
onMouseout="hideddrivetip()">"'.substr($title,0,20).'..."</a></li>';								
                              ...
                              <tr height="20">
                                ...
                                <td bgcolor="#FFCC99"><strong>Cruise starts    (strictly enforced)</strong></td>
                              </tr>
                              <tr height="20">
                                <td height="20" valign="top" bgcolor="#CCCCCC"><div align="right"></div></td>
