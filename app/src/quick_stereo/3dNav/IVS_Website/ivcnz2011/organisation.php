					...
					<div id='div_ivcnz_main'>
						...
						<div id='right_pad'>
                          <div style="text-align:center;">
						    ...
						    <h1 style="margin-top:0px;"><span class="style2">Organisation Committee</span></h1>
                          </div>                         
                          <table width="100%" border="1" bgcolor="#FFFFFF">
                            ...
                            <?
							$sql = "select * from persons where status like '%pc%' order by firstname";
							$result = mysql_query($sql) or die('Error, query'.$sql.'failed'.mysql_error());
							while($row = mysql_fetch_assoc($result)){
							?>
                            <tr>
                              <td><? echo $row["firstname"]." ".$row["name"]; ?></td>
