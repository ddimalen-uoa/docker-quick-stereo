					...
					<div id='div_ivcnz_main'>
						...
						<div id='right_pad'>
                          <div style="text-align:center;">
						    ...
						    <h1 style="margin-top:0px;"><span class="style2">Concomitant Events</span></h1>
                          </div>      
                          
                          If you plan travelling to New Zealand for IVCNZ 2011, why not also combine your trip with the following workshop:                   
                          <ul>
                            <li>
Joint Massey University / IEEE NZ Central Section Workshop Implementing Image Processing on FPGAs <br>
Palmerston North, 23-25 November, 2011<br> 
<a href="documents/ImageProcessingFPGAsFlyer.pdf">Read more</a>.</li>
                          </ul>
                          <? echo importantDate();?>
						  <hr>
