					...
					<div id='div_ivcnz_main'>
						...
						<div id='right_pad'>
                          <div style="text-align:center;">
						    ...
						    <h1 style="margin-top:0px;"><span class="style2"><a href="programme_.php">Programme</a></span></h1>
<h1 style="margin-top:0px;"><span class="style2"><a href="proceedings.pdf">Online proceedings</a></span></h1>

                          </div>                         
                          <ul>
                            <li><strong>Tuesday 29th November 2011: </strong>Conference starts.</li>
                            <li><strong>Wednesday 30th November 2011:</strong> Conference dinner on the <a href="http://daldy.com/" target="_blank">W C DALDY</a> (The last of the old great steam boats preserved by dedicated volunteers in its very original state).</li>
                            <li><strong>Thursday 1st December 2011: </strong>Conference ends.</li>
                          </ul>
                          <? echo importantDate();?>
						  <hr>
