...
form.addEventListener('submit', function(e) {
	...
	var agree = confirm("Do you agree to let us use your images for research and publication purposes only ?");

	if(!(imageleft.value[0] == undefined && imageright.value[0] == undefined && imageleftright.value[0] == undefined && anaglyph.value[0] == undefined && mpo.value[0] == undefined && stereogram.value[0] == undefined))
	{
		// If you upload left and right images
		if(imageleft.value[0] != undefined && imageright.value[0] != undefined)
		{
		...
		// If you upload combined left/right image
		else if(imageleftright.value[0] != undefined)
		{
			// Cases for the parameters
			if(((disp_scale.value <= 0 || disp_scale.value > 1) && disp_scale.value[0] != undefined) || (smooth.value < 0 || smooth.value > 50))
			{
		...
		// If you upload an anaglyph
		else if(anaglyph.value[0] != undefined)
		{
			// Cases for the parameters
			if(((disp_scale.value <= 0 || disp_scale.value > 1) && disp_scale.value[0] != undefined) || (smooth.value < 0 || smooth.value > 50))
			{
		...
		// If you upload a MPO/PNS/JPS 
		else if(mpo.value[0] != undefined)
		{
			// Cases for the parameters
			if(((disp_scale.value <= 0 || disp_scale.value > 1) && disp_scale.value[0] != undefined) || (smooth.value < 0 || smooth.value > 50))
			{
		...
		// If you upload a stereogram
		else if(stereogram.value[0] != undefined)
		{
			// Cases for the parameters
			if(((disp_scale.value <= 0 || disp_scale.value > 1) && disp_scale.value[0] != undefined) || (smooth.value < 0 || smooth.value > 50))
			{
		...
		{
			error_left_and_right.style.display = 'block';
		}
	}

	else
	{
		error_file.style.display = 'block';
	}
}, false);