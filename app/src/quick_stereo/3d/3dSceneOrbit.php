...
{
	$resultFile = "http://www.ivs.auckland.ac.nz/web/".$location."_CBP.jpg";
	$textureFile = "http://www.ivs.auckland.ac.nz/web/".$location."_l_resized.jpg";
}
...
function clock()
  {
	  ...
	  if(document.getElementById("fps").innerHTML == 'loading, if the 3D scene does not appear, press Refresh a few times'){	  
	  	document.location='3dSceneOrbit.php?location=<? echo $location; ?>';
	  }
	  else{
...
<body>
<p class="fps" id="fps" style="left:700px; top:0px; color:#FF0000";>loading, if the 3D scene does not appear, press Refresh a few times</p>
<div id="bg">
  <input class="3DNavRefreshButton" type="button" name="button" id="button" onClick="document.location='3dSceneOrbit.php?location=<? echo $location; ?>';" style="background:url(../img/Refresh.png); 
		width:50px; 
		height:50px;">
</div>
...
<script type="text/javascript" charset="utf-8">
	...
	window.onload = function(){		
		...
		jiggle();
		if(fps.innerHTML == 'loading, if the 3D scene does not appear, press Refresh a few times')
