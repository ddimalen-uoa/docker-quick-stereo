...
<html lang="en"><head>
	...
	<style type="text/css" media="screen">
		...
		#bg { position:absolute; top:1em; bottom:1em; left:0em; right:1em }
	...
	window.onload = function(){		
		...
		var jiggle = function(){
			...
			*/
			...
			{		
				{
					imageData.data[count]=255*Math.random();
				  	imageData.data[count+1]=255*Math.random();
				  	imageData.data[count+2]=255*Math.random();			  		  	  
				}	
			}
			/*
